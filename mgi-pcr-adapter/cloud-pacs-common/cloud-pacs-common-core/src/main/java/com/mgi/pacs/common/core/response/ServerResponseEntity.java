...
public class ServerResponseEntity<T> implements Serializable {
	...
	public static <T> ServerResponseEntity<T> success(T data) {
		...
		serverResponseEntity.setMsg("ok");
	...
	public static <T> ServerResponseEntity<T> fail(ResponseEnum responseEnum, String msg) {
		log.error(responseEnum.toString());
		ServerResponseEntity<T> serverResponseEntity = new ServerResponseEntity<>();
		serverResponseEntity.setMsg(msg);
		serverResponseEntity.setCode(responseEnum.value());
	...
	public static <T> ServerResponseEntity<T> fail(String msg) {
		ResponseEnum responseEnum = ResponseEnum.EXCEPTION;
		log.error(responseEnum.toString());
		ServerResponseEntity<T> serverResponseEntity = new ServerResponseEntity<>();
		serverResponseEntity.setMsg(msg);
		serverResponseEntity.setCode(responseEnum.value());
