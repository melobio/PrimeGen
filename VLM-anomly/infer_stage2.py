...
def main(
    ...
    with open(save_file, mode='w', newline='', encoding='utf-8') as csvfile:
        ...
        csv_writer.writerow(['query', 'img_path', 'true_answer', 'prediction', 'LLMscore', 'LLMjustification'])
        with open(data_path, 'r', encoding='utf-8') as f:
            ...
            for line in tqdm(lines, total=len(lines), desc="Processing"):
                ...
                llm_score, llm_justification = calculate_scores(true_answer, response)
                csv_writer.writerow([query, img_path, true_answer, response, llm_score, llm_justification])
