...
metadata = {
    'protocolName': 'MGIEasy_fastRNA_接头连接产物纯化_4',
    'author': 'MGIX',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    right_pipette = protocol.load_instrument('p300_multi_gen2', mount='right',
                                             tip_racks=[tips200_1, tips200_2, tips200_3, tips200_4, tips200_5,
                                                        tips200_6, tips200_7, tips200_8])
    ...
    for well_name in use_plate_well:
        mag_plate.wells_by_name()[well_name].load_liquid(liquid=connect_products, volume=120)
