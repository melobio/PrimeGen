...
def run(protocol: protocol_api.ProtocolContext):
    ...
    for ii in range(transfer_times):
        transfer_info_right7.append(('2', str(ii + 1), 21))
    ...
    transfer_info_left1 = []
    for ii in range(transfer_times):
        transfer_info_left1.append((str(ii + 1), str(ii + 1), 19))

    transfer_all(left_pipette, mag_plate, plate1, transfer_info_left1)
