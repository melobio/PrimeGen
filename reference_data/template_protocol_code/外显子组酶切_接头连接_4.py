...
def run(protocol: protocol_api.ProtocolContext):
    ...
    Adapter_ligation_volume = input_Adapter_ligation_volume_4
    ...
    tips200_4 = protocol.load_labware('opentrons_96_tiprack_300ul', '9')
    ...
    right_pipette = protocol.load_instrument('p300_multi_gen2', mount='right', tip_racks=[tips200_1,tips200_2,tips200_3,tips200_4])
    ...
    if use_col_nums>6:
        ...
        liquid_list1 = calculate_liquid(Sample_nums-48,Adapter_ligation_volume-162.5)
