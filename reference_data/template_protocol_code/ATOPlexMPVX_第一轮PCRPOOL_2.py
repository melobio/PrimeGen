...
def run(protocol: protocol_api.ProtocolContext):
    ...
    MIX_volume = input_PCR_MIX_volume_2
    ...
    steps1 = [{'temperature': 37, 'hold_time_minutes': 5}, {'temperature': 95, 'hold_time_minutes': 5}]
    steps2 = [{'temperature': 95, 'hold_time_seconds': 20}, {'temperature': 62, 'hold_time_minutes': 1},
              {'temperature': 58, 'hold_time_minutes': 1}, {'temperature': 72, 'hold_time_seconds': 20}]
    ...
    thermocycler_module.execute_profile(steps=steps2, repetitions=37,block_max_volume=25)
