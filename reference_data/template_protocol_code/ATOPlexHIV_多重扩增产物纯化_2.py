...
def run(protocol: protocol_api.ProtocolContext):
    ...
    tips200_4 = protocol.load_labware('oopentrons_96_tiprack_300ul', '7')
    ...
    for well_name in use_plate_well:
        mag_plate.wells_by_name()[well_name].load_liquid(liquid=PCR_1st, volume=50)
    ...
    for ii in range(transfer_times):
        transfer_info_right2.append((str(ii + 1), '5', 85))
