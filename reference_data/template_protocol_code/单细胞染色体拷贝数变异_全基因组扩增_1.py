...
def run(protocol: protocol_api.ProtocolContext):
    ...
    Cell_lysis_master_mix_volume = input_Cell_lysis_master_mix_volume_1
    Pre_PCR_master_mix_volume = input_Pre_PCR_master_mix_volume_1
    Post_PCR_master_mix_volume = input_Post_PCR_master_mix_volume_1
    Nuclease_free_water_volume = input_Nuclease_free_water_volume_1
