...
metadata = {
    'protocolName': 'MGIEasy_RNA方向性_PCR反应_5',
    'author': 'MGIX',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    MIX_volume = input_PCR_MIX_volume_5
    ...
    UDB_primer = protocol.define_liquid(
        name="UDB_primer",
        description="UDB_primer",
        display_color="#00FF00",
    )
    ...
    steps1 = [{'temperature': 37, 'hold_time_minutes': 20},{'temperature': 95, 'hold_time_minutes': 3}]
