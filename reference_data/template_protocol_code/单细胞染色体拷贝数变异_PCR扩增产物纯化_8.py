...
metadata = {
    'protocolName': '单细胞染色体拷贝数变异_PCR扩增产物纯化_8',
    'author': 'MGIX',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    Beads_volume = input_DNA_Beads_volume_8
    TE_Buffer_volume = input_TE_Buffer_volume_8
    Ethanol_80_volume = input_Ethanol_80_volume_8
