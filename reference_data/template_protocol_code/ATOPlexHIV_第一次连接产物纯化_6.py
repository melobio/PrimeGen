...
def run(protocol: protocol_api.ProtocolContext):
    ...
    Beads_volume = input_DNA_Beads_volume_6
    TE_Buffer_volume = input_TE_Buffer_volume_6
    Ethanol_80_volume = input_Ethanol_80_volume_6
    ...
    tips200_6 = protocol.load_labware('oopentrons_96_tiprack_300ul', '9')
