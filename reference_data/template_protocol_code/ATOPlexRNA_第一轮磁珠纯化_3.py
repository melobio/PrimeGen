...
def run(protocol: protocol_api.ProtocolContext):
    ...
    Spike_in_Control_PCR_block = input_Spike_in_Control_PCR_block_2
    Barcode_type = input_Barcode_type_3
    panel_amp_length = input_panel_amp_length_3
    ...
    for ii in range(transfer_times):
        transfer_info_right2.append((str(ii + 1), '5',2*beads_volume_1st))
    ...
    transfer_all(left_pipette, reservoir_plate, mag_plate, transfer_info_left1,mix_flag=1,mix_value=[10,5])
