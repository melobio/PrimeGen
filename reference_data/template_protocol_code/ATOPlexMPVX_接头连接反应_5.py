...
metadata = {
    'protocolName': 'MGIEasy ATOPlexMPVX-4',
    'author': 'MGIX',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    MIX_volume = input_Adapter_ligation_volume_5
...
#         temp_plate.wells_by_name()[well.display_name].load_liquid(liquid=Adapter_ligation_solution, volume=195)
    ...
    for well_name in use_plate_well:
        thermocycler_plate.wells_by_name()[well_name].load_liquid(liquid=Enzyme_digestion_solution_after, volume=60)
