...
metadata = {
    'protocolName': 'MGIEasy_fastRNA_RNA富集_1',
    'author': 'MGIX',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    Beads_volume = input_Beads_volume_1
    ...
    liquid_list_1 = calculate_liquid(Sample_nums, Washing_Buffer_volume)
    liquid_list_2 = calculate_liquid(Sample_nums, Beads_volume)
    for ii in range(8):
        deep_plate.wells_by_name()[all_plate_well[ii]].load_liquid(liquid=Beads, volume=liquid_list_2[ii])
        deep_plate.wells_by_name()[all_plate_well[8:16][ii]].load_liquid(liquid=Washing_Buffer, volume=liquid_list_1[ii])
    ...
    temp_shaker.set_temperature(65)  # Set temperature to 37 degrees Celsius
