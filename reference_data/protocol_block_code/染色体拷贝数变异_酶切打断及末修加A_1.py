...
def run(protocol: protocol_api.ProtocolContext):
    ...
    MIX_volume = input_Fragmentation_End_Repair_MIX_volume
    ...
    Fragmentation_End_Repair_MIX = protocol.define_liquid(
        name="Fragmentation_End_Repair_MIX",
    ...
    for ii in range(8):
        ...
        temp_plate.wells_by_name()[well_name].load_liquid(liquid=Fragmentation_End_Repair_MIX, volume=liquid_list[ii])
    ...
    steps1 = [{'temperature': 37, 'hold_time_minutes': 15}, {'temperature': 75, 'hold_time_minutes': 15}
