...
def run(protocol: protocol_api.ProtocolContext):
    ...
    Washing_Buffer_volume = input_Washing_Buffer_volume_2
    Binding_buffer_volume = input_Binding_buffer_volume
    TRIS_HCL_buffer_volume = input_TRIS_HCL_buffer_volume_1
    ...
    temp_shaker.set_temperature(80)  # Set temperature to 37 degrees Celsius
