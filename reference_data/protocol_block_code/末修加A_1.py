...
##
## This code block is suitable for end repair and A-tailing reactions in protocols such as Exome Enzyme Digestion, Enzyme DNA Digestion, Cell-free DNA, General DNA,
## Single Cell Chromosome Copy Number Variation/MGIEasy_RNA Directional, etc.
##
metadata = {
    'protocolName': 'Enzyme DNA End Repair and A-tailing 3',
    'author': 'MGIX',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    MIX_volume = input_A_MIX_volume
    
    thermocycler_param = input_thermocycler_param
    #[{'temper_time':[(37,1800),(65,900),(4,60)],'repetition':1}]
