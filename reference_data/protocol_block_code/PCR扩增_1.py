...
#     thermocycler_param = [{'temper_time':[(98,120)],'repetition':1},
#                     {'temper_time':[(98,15),(56,15),(72,30)],'repetition':12},
#                     {'temper_time':[(72,300),(4,60)],'repetition':1}]
...
#     repet_times = get_PCR_repet(DNA_quality,DNA_quality)
    ...
    if use_col_nums > 6:
        ...
        liquid_list = calculate_liquid(Sample_nums - 48, PCR_MIX_volume - half_volume*8,cal_type=2)
        for ii in range(8):
