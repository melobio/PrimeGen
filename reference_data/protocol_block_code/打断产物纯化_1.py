...
##
## This code block is suitable for the purification step of fragmented products in protocols like
## Single Cell Chromosome Copy Number Variation/Exome Enzyme Digestion/Enzyme DNA Digestion, etc.
##
metadata = {
    'protocolName': 'Enzyme DNA Digestion - Fragmented Product Purification 2',
    'author': 'MGIX',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    for ii in range(transfer_times):
        transfer_info_right8.append((str(ii + 1), str(ii + 1), 41))
