...
2.exist (If the species name mentioned by the user is in our species list, please return true, if not, please return false)  
...
"""
        ...
        pathogen_drug_resistance_dict["species_name"] = experiment_info_json_data["species_name"]
        pathogen_drug_resistance_dict["exist"] = experiment_info_json_data["exist"]
        
        print(pathogen_drug_resistance_dict["species_name"],pathogen_drug_resistance_dict["exist"])
        if pathogen_drug_resistance_dict["exist"]=="true" and pathogen_drug_resistance_dict["species_name"] != 'null':
            ...
            return {"response": response, "operations":[{"title":"Resistance information","options":result,"type":["single","input"],"key":"drug_select","value":[]}],"stage": stage,
                            ...
                            "pathogen_drug_resistance_dict": pathogen_drug_resistance_dict}
                            
        elif pathogen_drug_resistance_dict["exist"]=="false" and pathogen_drug_resistance_dict["species_name"] != 'null':
        ...
        stage+=1
        pathogen_drug_resistance_dict = instruction['instruction']['pathogen_drug_resistance_dict']
        if pathogen_drug_resistance_dict["exist"]=="true" and pathogen_drug_resistance_dict["species_name"] != 'null':
            ...
            if species_name.lower() == 'mycobacterium tuberculosis':
                ...
                return {"response": response,"operations":[],"filter_result_path":save_path,'sequences':MTBseq,
                    "search_type": "pathogen_drug_resistance_type", "stage":stage,"search_system_prompt": pathogen_drug_resistance_prompt,
                    "state": 'stop'}
                    
            else:
                return {"response": response,"operations":[],"filter_result_path":save_path,'sequences':'',"search_type": "pathogen_drug_resistance_type",
