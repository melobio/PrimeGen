<template>
  ...
  >
    ...
    >
      <NodeInputsField
        required
        :editable="Boolean(localData.uuid)"
...
import type {InputProp, LLMProp} from '@/pages/main/tools/common/flow/NodeTypes'
// import type {Agent} from '@/stores/tools-types'
import {updateAgents, updateInput, updateLLMs} from "@/api";
import NodeChildField from "@/pages/main/tools/common/flow/fields/NodeChildField.vue";
import type {InputNode} from "@xpcr/common";
import {NodeTypeColors} from "@xpcr/common/src/node";
import NodeInputsField from "@/pages/main/tools/common/flow/fields/NodeInputsField.vue";
...
const localData = ref<InputNode>(props.data);
