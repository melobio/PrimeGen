...
import type { DeviceProp} from '@/pages/main/tools/common/flow/NodeTypes'
import {checkDeviceState, updateDevice} from "@/api";
import NodeOnlineField from "@/pages/main/tools/common/flow/fields/NodeOnlineField.vue";
import {Handle, Position} from "@vue-flow/core";
import type {DeviceNode} from "@xpcr/common";
...
watch(() => localData, () => {
  ...
  updateDevice(localData.uuid, localData).then((res) => {
    if (res.success) {
      // 更新成功！
    }
  })
