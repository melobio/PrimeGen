import pipetteNameSpecs from './assets/pipette/definitions/1/pipetteNameSpecs.json'
import pipetteModelSpecs from './assets/pipette/definitions/1/pipetteModelSpecs.json'
