import gripperV1 from './assets/gripper/definitions/1/gripperV1.json'
import gripperV1_1 from './assets/gripper/definitions/1/gripperV1.1.json'
import gripperV1_2 from './assets/gripper/definitions/1/gripperV1.2.json'
