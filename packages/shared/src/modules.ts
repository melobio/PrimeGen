import magneticModuleV1 from './assets/module/definitions/3/magneticModuleV1.json'
import magneticModuleV2 from './assets/module/definitions/3/magneticModuleV2.json'
import temperatureModuleV1 from './assets/module/definitions/3/temperatureModuleV1.json'
import temperatureModuleV2 from './assets/module/definitions/3/temperatureModuleV2.json'
import thermocyclerModuleV1 from './assets/module/definitions/3/thermocyclerModuleV1.json'
import thermocyclerModuleV2 from './assets/module/definitions/3/thermocyclerModuleV2.json'
import heaterShakerModuleV1 from './assets/module/definitions/3/heaterShakerModuleV1.json'
import magneticBlockV1 from './assets/module/definitions/3/magneticBlockV1.json'
