...
## primer3.calc_hairpin(left_primer)
aa_dict = {'AA':-7.6,'AT':-7.2,'AC':-8.4,'AG':-7.2,
...
class primer_generator(object):
    ...
    def get(self, seq, prefix='', l_r_flag='', dG_max=-11.8, min_GC=0.2, max_GC=0.75, 
