...
#Example is shown below:
        ...
        {"title":"upload gene file", "options":[], "type":["file"], "key":"gene_path", "value":[]}],
    ...
    # user select --> gene sequence and snp
        ...
        if len(gene_path) != 0:
            ...
            return {"response": response, "operations":[],"data":{"target_gene_info": gene_path}
        ...
        if len(name_mutation_csv) == 0:
            ...
            return {"response": response, "operations":[],"data":{"target_gene_info": result_data},
                    "search_type": "cancer_type",
